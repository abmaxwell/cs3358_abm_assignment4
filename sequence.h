// FILE: sequence.h (part of the namespace CS3358_FA17_A04_sequence)
//
// TEMPLATE CLASS PROVIDED: sequence<Item>
//
// CLASS DESCRIPTION: sequence<Item> is a templated container class for a
//                    list of items, where each list may have a designated
//                    item called "current item").
//
...
//      sequence, also defined as sequence<Item>::value_type. It may be any
//      of the C++ built-in types (int, char, etc.), or a class with a
//      default constructor, an assignment operator, and a copy constructor.
//
//   typedef ____ sequence<Item>::size_type
//      The definition bag<Item>::size_type is the data type
//      of any variable that keeps track of how many items are in a bag.
//
//   static const size_type CAPACITY = _____
//      The static const DEFAULT_CAPACITY is the initial capacity of a sequence
